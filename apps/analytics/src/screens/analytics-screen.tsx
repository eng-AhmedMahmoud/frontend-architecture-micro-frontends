...
import { fetchAnalyticsOverview } from "@commerceos/shared/api/analytics";
...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@commerceos/ui";
import { ChartContainer, ChartTooltip, ChartTooltipContent } from "@commerceos/ui";
import { formatCurrency, formatNumber } from "@commerceos/shared/lib/utils";
import { AnalyticsSummaryStats } from "../features/overview/analytics-summary-stats";
import { formatAnalyticsMonth, formatAnalyticsWeek } from "@commerceos/shared/utils/analytics-date";
...
export function AnalyticsScreen() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AnalyticsSummaryStats analytics={data} />
